...
# def catch(keyword, plaontext):
#     alphabet = list("абвгґдеєжзиіїйклмнопрстуфхцчшщьюя ,:.;-/")
#     append_char = len(plaontext)% len(keyword)
                                          

#     key = list(keyword)
#     plaontext = list(plaontext)

    

#     for i in range(append_char):
#         plaontext.append(' ')
